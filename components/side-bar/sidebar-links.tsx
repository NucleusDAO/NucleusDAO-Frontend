...
const Sidebar = ({ showNav, handleShowNav }: ISidebar) => {
  ...
  return (
    <div className={cn("w-[75%] md:w-[18%] px-4 md:px-4 lg:px-10 py-2 dark:bg-foreground bg-light space-y-20 h-full z-[999] fixed max-w-[400px] ease-in-out duration-300",
