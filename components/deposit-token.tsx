          ...
          <DialogDescription className="font-light space-y-3">
            ...
            <div className="space-y-4">
              ...
              <div className="border border-[#292929] rounded-lg p-2 flex justify-between">
                <div className="relative w-[40%]">
                  <Input
                    ...
                    value={aeValue}
                    onChange={({ target }) => handleChangeNumberInput(target.value, setAeValue)}
                  />
                ...
                <div className="relative w-[40%]">
                  <Input
                    ...
                    value={usdValue}
                    onChange={({ target }) => handleChangeNumberInput(target.value, setUsdValue)}
                  />
                  <p className="dark:text-white right-4 text-dark absolute top-[27%] font-medium">
                    USD
                  </p>
              ...
              <div className="flex items-center space-x-2 pt-3">
                ...
                >
                  By clicking, I agree to sign the <span className='text-primary underline underline-offset-2'>superhero contract</span> to send funds.
                </label>
              </div>
              <Button className='w-full' disabled={!termsChecked || Number(usdValue) <= 0}>{`Deposit $${usdValue}`}</Button>
            </div>
          </DialogDescription>
        </DialogHeader>
      </DialogContent>
