...
const NavComp = () => {
  ...
  return (
    <nav className="px-8 lg:px-16 lg:items-center block lg:flex pt-4 pb-4 justify-between fixed inset-0 items-start z-[40] lg:top-0 backdrop-filter backdrop-blur-md h-fit">
      <div className="flex justify-between items-center w-full">
        ...
        />
        <Link href="#" className="lg:flex hidden" target="_blank">
