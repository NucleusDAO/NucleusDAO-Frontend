...
const proposalData: { type: string; status: string; description: string; wallet: string; duration: string; totalVote: string; organisation: string; logo: ReactNode; id: string; }[] = [
    {
        type: 'Brand Identity Change',
        status: 'Active',
        organisation: 'Legacy',
        description: 'Making a change of brand identity and UI features that can enhance the usability and functionality of Legacy.',
