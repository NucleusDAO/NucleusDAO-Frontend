      ...
      >
        ...
        <div className="space-y-8 w-full lg:w-[65%] text-center mx-auto">
          ...
          <p className="font-light px-6 lg:px-12 lg:text-base text-sm">
            Be among the first to shape the future of decentralized governance.
            Sign up now for exclusive access to updates, insights, and a chance
            to participate in our launch.
          </p>
