...
<MainSection />
        <div className="text-center mx-auto">
          <Lottie options={defaultProposalOption} height={320} width={isDesktop ? 420 : 300} />
        </div>
      </main>
      <section
      ...
      >
        <div className="border border-[#5E5F62B9] mx-auto lg:mx-0 text-sm bg-gradient-to-r from-[#44444433] to-[#65656533] px-6 py-2 rounded-[20px] w-fit text-[#9050E9]" role='heading'>
        ...
        <div className='w-full lg:w-[65%] space-y-2 pb-4'>
            ...
            <p className='font-light lg:text-normal text-center lg:text-left text-sm'>NucleusDAO embraces true autonomy by empowering communities to create DAOs with unparalleled transparency, user-centric design, and fair decision-making. We prioritize seamless participation and collaboration, ensuring every voice matters in shaping the future.</p>
        </div>
        ...
        <div className='border border-[#656565] py-8 px-6 lg:px-14 rounded-[20px] bg-gradient-to-r from-[#1E1E1E33] to-[#19191933] lg:flex-row flex-col-reverse flex justify-between items-center'>
          <div className='space-y-4 lg:space-y-8 lg:pl-16'>
            <h2 className='text-white font-medium text-[24px] lg:text-[28px] w-full lg:w-[60%] mt-4 lg:mt-0'>Launch your DAO with an Inclusive Builder</h2>
...
<FeaturesComp />
      ...
      >
        ...
        <div className='space-y-4 w-full lg:w-[65%] text-center mx-auto pb-16'>
          <Heading title='Navigating Decentralized Governance: A Step-by-Step Guide' className='lg:text-center' />
          <p className='font-light text-sm lg:text-normal'>Discover how NucleusDAO simplifies decentralized governance through our intuitive step-by-step guide. Watch short animations to see how you can create, manage, and participate in DAOs with ease.</p>
        </div>
      ...
      >
        <div className='space-y-4 lg:space-y-8 w-full lg:w-[65%]'>
                <div className="border mx-auto lg:mx-0 border-[#5E5F62B9] text-sm bg-gradient-to-r from-[#44444433] to-[#65656533] px-6 py-2 rounded-[20px] w-fit text-[#9050E9]" role='heading'>
        <h2>Blockchain</h2>
        </div>
        ...
        <div className="flex flex-col lg:min-h-[90vh] bg-contain bg-no-repeat w-full px-6 lg:px-24 pb-5"                       style={{
                        background: 'round',
        ...
        >
          ...
          <div className='space-y-8 w-full lg:w-[65%] text-center mx-auto'>
            <Heading title='Join the Early Community' className='lg:text-center' />
            <p className='font-light text-sm lg:text-normal'>Be among the first to shape the future of decentralized governance. Sign up now for exclusive access to updates, insights, and a chance to participate in our launch.</p>
