...
const ConfirmDisconnectWallet = ({ setOpen, open, setUser, defaultUser }: IConfirmDisconnectWallet) => {
  ...
  return (
    <AlertDialog onOpenChange={setOpen} open={open}>
      ...
      <AlertDialogContent className="dark:bg-[#191919] bg-light">
        <AlertDialogHeader>
          <AlertDialogTitle className={cn('font-medium py-3 text-white text-center')}>
            Disconnect Wallet
          </AlertDialogTitle>
        ...
        <div className='grid grid-cols-1 gap-4'>
          <AlertDialogAction onClick={handleDisconnect}>{disconnecting ? 'Disconnecting...' : 'Continue'}</AlertDialogAction>
