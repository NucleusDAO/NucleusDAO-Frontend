...
const proposalLists: { title: string; enums: number; type: string }[] = [
  ...
  {
    title: 'Proposal to add a new member to the group',
    type: 'addMember',
    enums: 1,
  },
  {
    title: 'Proposal to remove a member from the group',
    type: 'removeMember',
    enums: 2,
  },
  {
    title: 'Proposal to change voting time',
    type: 'updateVoteTime',
    enums: 3,
  },
  {
    title: 'Proposal to change the quorum',
    type: 'updateQuorum',
    enums: 4,
  },
  {
    title: 'Proposal to change DAO’s name',
    type: 'updateName',
    enums: 5,
  },
  {
    title: 'Proposal to change DAO’s logo',
    type: 'updateImage',
    enums: 6,
  },
  {
    title: 'Proposal to add social links',
    type: 'updateSocials',
    enums: 7,
  },
  {
