...
// Create DAO
export const SELECT_DAO_STYLE_URL: string = '/daos/create-new';
export const DAO_INFO_URL: string = '/daos/dao-info';
export const DEFINE_MEMBERSHIP_URL: string = '/daos/membership';
